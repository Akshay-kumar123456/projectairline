...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
		.authorizeRequests()
		.antMatchers("/route/add","/airline/add","/airline/delete/{id}","/executive/totalusers","/executive/totalairlines","/flight/getbyairline/{date}/{aid}","/flight/getbytoday/{aid}","/flight//delete/{fid}","/flight/delete/{fid}","/flight/update/{id}/{date}","/flight/add/{aid}","/customerflight/flight/passengers/{fid}/{date}","/flight/getbyairline/{aid}","/airline/statistics/income/{aid}","/airline/statistics/passengers/{aid}","/airline/statistics/flights/{aid}","/customer/signup","/executive/add","/auth/login","/flight/all","/flight/getbysdd","/airline/getall","/route/getall","/flight/getbysdd/filter","/user/login","/flight/getone/{fid}","/getall/{fid}","/getavaliable/{fid}","/customerflight/bookticket/{cid}/{fid}","/customerflight/bookings/{cid}").permitAll()
		.antMatchers("/flight/add/{aid}").hasRole(Role.AIRLINE.name())
